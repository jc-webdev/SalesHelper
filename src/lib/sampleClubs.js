export const sampleCsv = `Nazwa klubu,adres strony,mail kontaktowy 1,mail kontaktowy 2,Nr telefonu,Imie i nazwisko kontaktu,status,Padel double,Padel Single,Ilość kamer,Województwo,Notatka
